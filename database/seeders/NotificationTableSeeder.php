...
class NotificationTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Settings::group('notification')->set([
            ...
            'notification_fcm_auth_domain'         => $envService->getValue('DEMO') ? 'sohojrms-5102b.firebaseapp.com' : '',
            'notification_fcm_project_id'          => $envService->getValue('DEMO') ? 'sohojrms-5102b' : '',
            'notification_fcm_storage_bucket'      => $envService->getValue('DEMO') ? 'sohojrms-5102b.appspot.com' : '',
