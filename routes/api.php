...
Route::prefix('admin')->name('admin.')->middleware(['installed', 'apiKey', 'auth:sanctum', 'localization'])->group(function () {
    ...
    Route::prefix('setting')->name('setting.')->group(function () {
        Route::prefix('setting-menu')->name('setting-menu.')->group(function () {
            Route::get('/', [SettingMenuController::class, 'index']);
        });
        ...
        Route::prefix('tax')->name('tax.')->group(function () {
            ...
            Route::post('/translations/{tax}', [TaxController::class, 'saveTranslations']);
        });
        ...
        Route::prefix('item-attribute')->name('item-attribute.')->group(function () {
            ...
            Route::post('/translations/{itemAttribute}', [ItemAttributeController::class, 'saveTranslations']);
        });
