<template>
    ...
    <TaxTranslationComponent :tax="selectedTax" />
</template>
<script>
import LoadingComponent from "../../components/LoadingComponent";
import TaxCreateComponent from "./TaxCreateComponent";
import TaxTranslationComponent from "./TaxTranslationComponent.vue";
...
export default {
    ...
    methods: {
        ...
        translate: function (tax) {
            this.loading.isActive = true;
            this.$store.dispatch("tax/show", tax.id).then(res => {
                this.selectedTax = res.data.data;
                this.loading.isActive = false;
                appService.modalShow('#tax-translation-modal');
            }).catch(() => {
                this.loading.isActive = false;
            });
        },
