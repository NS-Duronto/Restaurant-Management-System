    ...
    <div id="sms" class="db-tab-div active">
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3 mb-5">
            <button @click="selectActive(index)"
                ...
                :data-tab="'#' + smsGateway.slug" v-for="(smsGateway, index) in smsGateways"
                :key="smsGateway" :class="index === selectIndex ? '!text-white !bg-primary !border-primary font-bold shadow-md shadow-orange-500/20' : ''">
