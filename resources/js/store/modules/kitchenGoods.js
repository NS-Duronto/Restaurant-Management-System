...
export const kitchenGoods = {
    ...
    actions: {
        ...
        save: (context, payload) => {
            return new Promise((resolve, reject) => {
                ...
                if (context.state.temp.isEditing) {
                    method = axios.put;
                    url = `/admin/kitchen-goods/${context.state.temp.temp_id}`;
                }
        ...
        destroy: (context, payload) => {
            return new Promise((resolve, reject) => {
                axios.delete(`admin/kitchen-goods/${payload.id}`).then((res) => {
                    context.dispatch('lists', payload.search).then().catch();
                    resolve(res);
                }).catch((err) => reject(err));
            });
        ...
        show: (context, payload) => {
            return new Promise((resolve, reject) => {
                axios.get(`admin/kitchen-goods/show/${payload}`).then((res) => {
