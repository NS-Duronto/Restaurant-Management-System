...
export const kitchenGoodsCategory = {
    namespaced: true,
    state: {
        lists: [],
        page: {},
    ...
    actions: {
        lists: (context, payload) => {
            return new Promise((resolve, reject) => {
                let url = 'admin/kitchen-goods-category';
                if (payload) {
        ...
        save: (context, payload) => {
            return new Promise((resolve, reject) => {
                ...
                if (context.state.temp.isEditing) {
                    method = axios.post;
                    url = `/admin/kitchen-goods-category/${context.state.temp.temp_id}`;
                }
        ...
        destroy: (context, payload) => {
            return new Promise((resolve, reject) => {
                axios.delete(`admin/kitchen-goods-category/${payload.id}`).then((res) => {
                    context.dispatch('lists', payload.search).then().catch();
                    resolve(res);
                }).catch((err) => reject(err));
            });
        ...
        show: (context, payload) => {
            return new Promise((resolve, reject) => {
                axios.get(`admin/kitchen-goods-category/show/${payload}`).then((res) => {
