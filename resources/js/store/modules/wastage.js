...
export const wastage = {
    ...
    actions: {
        ...
        save: (context, payload) => {
            return new Promise((resolve, reject) => {
                axios.post('/admin/wastage', payload.form).then(res => {
        ...
        destroy: (context, payload) => {
            return new Promise((resolve, reject) => {
                axios.delete(`admin/wastage/${payload.id}`).then((res) => {
                    context.dispatch('lists', payload.search).then().catch();
                    resolve(res);
                }).catch((err) => reject(err));
            });
        ...
        show: (context, payload) => {
            return new Promise((resolve, reject) => {
                axios.get(`admin/wastage/show/${payload}`).then((res) => {
