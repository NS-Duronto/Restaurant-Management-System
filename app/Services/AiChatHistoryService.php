...
class AiChatHistoryService
{
     ...
     * @throws Exception
     */
    public function list(Branch $branch)
    {
        try {
            return AiChatHistory::where(['branch_id' => $branch->id, 'user_id' => Auth::user()->id, 'ai_agent_id' => Settings::group('site')->get('site_default_ai_agent')])->orderBy('id', 'asc')->get();
     ...
     * @throws Exception
     */
    public function store(AiRequest $aiRequest, Branch $branch)
    {
        try {
