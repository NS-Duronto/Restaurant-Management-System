    ...
    public function toArray($request): array
    {
        ...
        return [
            ...
            "category"         => $this->category ? [
                ...
                'description' => $this->category->description === null ? '' : $this->category->description,
                'status'      => $this->category->status,
                'thumb'       => $this->category->thumb,
            ...
            "tax"              => $this->tax ? [
                ...
                'tax_currency_rate' => AppLibrary::flatAmountFormat($this->tax->tax_rate),
                'type'              => $this->tax->type,
