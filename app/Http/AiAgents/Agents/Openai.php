...
class Openai extends AiAbstract
{
     ...
     * @throws Exception
     */
    public function caution(AiRequest $aiRequest): array|string|\Illuminate\Contracts\Translation\Translator|null
    {
        try {
            $response = $this->agent->responses()->create([
                'model' => 'gpt-4o',
                'input' => $this->buildProductCautionPrompt($aiRequest->name),
            ]);
